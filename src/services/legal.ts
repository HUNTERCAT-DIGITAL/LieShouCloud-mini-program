/**
 * 小程序 legal service（ADR-0036/0045 · 案件管理 + 办案时间线）.
 */
import { ApiError, request } from "@lieshoucloud/api-client";
...
/** 错误窄化：404 = 跨租户/不存在（小程序端用） */
export function isLegalApiError(e: unknown): e is ApiError {
